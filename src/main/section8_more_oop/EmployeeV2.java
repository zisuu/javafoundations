...
public abstract class EmployeeV2 implements IEmployee{
    ...
    protected EmployeeV2(String personText) {
        peopleMat = EmployeeV2.PEOPLE_PAT.matcher(personText);
        if (peopleMat.find()) {
    ...
    public static final IEmployee createEmployee(String employeeText){
        Matcher peopleMat = EmployeeV2.PEOPLE_PAT.matcher(employeeText);
    ...
    public static final class DummyEmployee extends EmployeeV2{
        @Override
